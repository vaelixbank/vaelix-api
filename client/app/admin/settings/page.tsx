              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                  />
                  <label htmlFor="aml-alerts" className="ml-2 block text-sm text-gray-900">
                    AML flag alerts
                  </label>
                </div>
                <div className="flex items-center">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-yellow-700">
                        <p>System settings are managed by the development team. Contact support for configuration changes.</p>
                      </div>
                    </div>
                  </div>
                </div>
