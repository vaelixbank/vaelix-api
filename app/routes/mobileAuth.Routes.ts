...
router.post('/register', validateDeviceId, validateRequiredFields(['email', 'phone', 'full_name', 'password']), MobileAuthController.register);
...
router.post('/password-reset/confirm', validateRequiredFields(['token', 'new_password']), MobileAuthController.passwordResetConfirm);
